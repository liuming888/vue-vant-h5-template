    ...
    <div class="my-container">
        <section class="my-header">
            <div class="my-info">
                ...
                <div class="my-info-detail">
                    ...
                    <img class="member" src="@/assets/images/VIPmember.png" alt="">
                </div>
                <a class="my-right-btn" href="javascript">
                    Cash out
                </a>
            </div>
            <div class="my-wallet">
        ...
        <ul class="my-control">
            <li class="my-control-item">
                <img src="@/assets/images/Invitefriends.png" alt="">
                <p>My friends</p>
            </li>
            <li class="my-control-item">
                <img src="@/assets/images/Invitefriends.png" alt="">
        ...
        <div class="hero-rank">
            ...
            <ul class="hero-list">
                ...
                <li class="hero-list-item" v-for="(item, index) in heroList" :key="index">
                    <div class="column">
                        <div class="hero-img first">
                            <img :src="item.imgUrl" alt="">
                        </div>
                        <div class="hero-info">
                            <div v-if="index < 3" alt="" :class="`hero-no hero-no-${index + 1}`"></div>
                            <p v-else class="hero-no">NO.{{index + 1}}</p>
                            <p class="hero-name">{{item.name}}</p>
                        </div>
                    </div>
                    <div class="column">{{item.fans}}</div>
                    <div class="column">{{item.icome}}</div>
                </li>
            </ul>
        </div>
    </div>
